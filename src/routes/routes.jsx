...
const publicRoute = [
  ...
  { path: '/viewinfomationpages/:tutorid', component: ViewInfomationPage, layout: DefaultLayout, allowedRoles: ["default"] },
...
const privateRoute = [
  ...
  { path: '/homeworklist/:classcourseid', component: HomeworkList, layout: LayoutTutor, allowedRoles: ["tutor"] },
