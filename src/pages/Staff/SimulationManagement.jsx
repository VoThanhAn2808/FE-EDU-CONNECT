...
function SimulationManagement() {
    ...
    const handleOpenUd = (demoid) => {
        try {
            axios
                .get(`http://ec2-13-250-214-184.ap-southeast-1.compute.amazonaws.com:8081/demo/detaildemo?demoid=${demoid}`)
                .then((response) => {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            ...
            const response = await axios.post(
                "http://ec2-13-250-214-184.ap-southeast-1.compute.amazonaws.com:8081/demo/adddemo",
                formData,
                {
                    headers: {
    ...
    const handleSubmitUd = async (event) => {
        ...
        try {
            ...
            const response = await axios.put(
                "http://ec2-13-250-214-184.ap-southeast-1.compute.amazonaws.com:8081/demo/updatedemo",
                formData,
                {
                    headers: {
                        "Content-Type": "multipart/form-data",
    ...
    useEffect(() => {
        axios
            .get(`http://ec2-13-250-214-184.ap-southeast-1.compute.amazonaws.com:8081/demo/listdemo?classid=${classid}&courseName=${courseName}`)
            .then((response) => {
        ...
        axios
            .get(`http://ec2-13-250-214-184.ap-southeast-1.compute.amazonaws.com:8081/demo/listclass`)
            .then((response) => {
        ...
        axios
            .get(`http://ec2-13-250-214-184.ap-southeast-1.compute.amazonaws.com:8081/demo/listcourse`)
            .then((response) => {
                                ...
                                (demo.map((item, index) => (
                                    <TableRow key={index}>
                                        ...
                                        <TableCell sx={{ fontSize: "15px", fontFamily: "cursive", textAlign: "center" }}>
                                            <img src={`http://ec2-13-250-214-184.ap-southeast-1.compute.amazonaws.com:8081/edu/file/files/${item.img}`} alt="an" style={{ width: '100px', height: '100px', borderRadius: '50%' }} />
                                        </TableCell>
                                        <TableCell sx={{ fontSize: "15px", fontFamily: "cursive", textAlign: "center" }}>
