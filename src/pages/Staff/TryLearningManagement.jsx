...
function TryLearningManagement() {
    ...
    const fetchData = useCallback((pageNumber) => {
        axios
            .get(`http://capstone.recoff.cloud:8081/staffsconnect/studentTrylearning/${pageNumber}`)
            .then((response) => {
    ...
    useEffect(() => {
        axios
            .get(`http://capstone.recoff.cloud:8081/staffsconnect/counttrylearnpage`)
            .then((response) => {
    ...
    const handleClickChange = async (event) => {
        ...
        try {
            ...
            const response = await axios.put(
                `http://capstone.recoff.cloud:8081/staffsconnect/accepttrylean`,
                {
