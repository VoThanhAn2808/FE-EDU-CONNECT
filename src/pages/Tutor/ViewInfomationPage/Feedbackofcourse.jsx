...
function Feedbackofcourse() {
  ...
  useEffect(() => {
    axios
      .get(`http://capstone.recoff.cloud:8081/educonnect/studentviewdetailtutor?tutorid=${decodedToken.id}`)
      .then((response) => {
    ...
    axios
      .get(`http://capstone.recoff.cloud:8081/educonnect/tutor/listcourse?tutorid=${decodedToken.id}`)
      .then((response) => {
    ...
    axios
      .get(`http://capstone.recoff.cloud:8081/educonnect/feedbackofcourse/${decodedToken.id}/${classcourseid}`)
      .then((response) => {
