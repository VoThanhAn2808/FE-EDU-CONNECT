...
function StaffManagement() {
    ...
    const handleLinkClick = async (event) => {
        ...
        try {
            axios
                .get(`http://ec2-13-250-214-184.ap-southeast-1.compute.amazonaws.com:8081/staffsconnect/ViewInfoStaff?staffId=${staffs}`)
                .then((response) => {
    ...
    const fetchData = useCallback((pageNumber) => {
        axios
            .get(`http://ec2-13-250-214-184.ap-southeast-1.compute.amazonaws.com:8081/admin/staff?page=${pageNumber}`)
            .then((response) => {
    ...
    useEffect(() => {
        axios
            .get(`http://ec2-13-250-214-184.ap-southeast-1.compute.amazonaws.com:8081/admin/totalpage`)
            .then((response) => {
    ...
    const handleClickChange = async (staffid, event) => {
        ...
        try {
            await axios.put(
                `http://ec2-13-250-214-184.ap-southeast-1.compute.amazonaws.com:8081/admin/staff/updatesalary`,
                {
                    staffid: staffid,
                    salary: staff.salary,
                },
    ...
    const handleDelete = async (staffid, event) => {
        ...
        try {
            await axios.delete(
                `http://ec2-13-250-214-184.ap-southeast-1.compute.amazonaws.com:8081/admin/staff/deletestaff/${staffid}`,
                {
                    headers: {
                        "Content-Type": "application/json",
                    },
    ...
    const handleSubmitAdd = async (event) => {
        ...
        try {
            ...
            await axios.post(
                "http://ec2-13-250-214-184.ap-southeast-1.compute.amazonaws.com:8081/admin/addstaff",
                formData,
                {
                    headers: {
        ...
        <Box >
            ...
            <Box sx={{
                ...
                <Box sx={{
                    ...
                    >
                        <Box sx={style}>
                            <Avatar src={`http://ec2-13-250-214-184.ap-southeast-1.compute.amazonaws.com:8081/edu/file/files/${staff.img}`} sx={{ width: '90px', height: '90px', marginLeft: 'auto', marginRight: 'auto', marginBottom: '20px' }} />
