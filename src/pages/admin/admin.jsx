...
function Admin() {
  ...
  useEffect(() => {
    ...
    axios
      .get(`http://ec2-13-250-214-184.ap-southeast-1.compute.amazonaws.com:8081/admin/adminstatisticscurrentmonth`)
      .then((response) => {
    ...
    axios
      .get(`http://ec2-13-250-214-184.ap-southeast-1.compute.amazonaws.com:8081/admin/adminstatisticspreviousmonth`)
      .then((response) => {
